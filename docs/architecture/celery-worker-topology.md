...
| `JOURNAL_BROWSER_PUMP_INTERVAL_SECONDS` | API | Minimum seconds between browser-triggered pump runs per branch; default `30` |
| `JOURNAL_BROWSER_PUMP_BATCH_SIZE` | API | Number of journal workload and trainees items the browser pump processes per heartbeat; default `1`, maximum `20` |
