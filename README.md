...
- аркуш із даними слухачів: `Додаток` (назва самого Excel-файла може бути довільною).
...
### Автоімпорт файлів з окремої папки Google Drive
