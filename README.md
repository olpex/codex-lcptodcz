...
Розділ `Журнали` порівнює підпапки з Google Drive з групами, розкладом і слухачами в системі. Для синхронізації папок, доступних за посиланням для перегляду, задайте на backend змінну:
