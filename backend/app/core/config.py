...
class Settings(BaseSettings):
    ...
    journal_browser_pump_enabled: bool = Field(default=True)
    journal_browser_pump_interval_seconds: int = Field(default=300)
    journal_browser_pump_batch_size: int = Field(default=5, ge=1, le=20)
    ...
    google_drive_intake_batch_size: int = Field(default=50, ge=1, le=50)
