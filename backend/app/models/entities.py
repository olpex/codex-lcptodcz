...
class Trainee(Base):
    ...
    employment_center_encrypted: Mapped[str | None] = mapped_column(Text, nullable=True)
    contract_number: Mapped[str | None] = mapped_column(String(120), nullable=True, index=True)
    ...
    postal_index: Mapped[str | None] = mapped_column(String(20), nullable=True)
    address_encrypted: Mapped[str | None] = mapped_column(Text, nullable=True)
    passport_series_encrypted: Mapped[str | None] = mapped_column(Text, nullable=True)
    passport_number_encrypted: Mapped[str | None] = mapped_column(Text, nullable=True)
    passport_issued_by_encrypted: Mapped[str | None] = mapped_column(Text, nullable=True)
...
class Teacher(Base):
    ...
    annual_load_hours: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=utcnow, nullable=False)
