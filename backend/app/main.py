...
def ensure_runtime_schema() -> None:
    ...
    with engine.begin() as conn:
        ...
        column_plan = [
            ...
            ("journal_monitor_sections", "last_processing_message", "VARCHAR(500) NULL"),
            ("journal_monitor_sections", "priority_entry_ids", "JSON NULL"),
            ("journal_monitor_sections", "priority_queue_year", "INTEGER NULL"),
            ...
            ("journal_monitor_entries", "trainees_status", "VARCHAR(50) NOT NULL DEFAULT 'pending'"),
